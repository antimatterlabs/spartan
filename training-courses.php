<?php
$page_title = 'Safety & Training | Spartan Industrial Marine';
...
$training_courses = [
    ...
    [
        ...
        'image' => 'assets/images/training/training-overhead-crane-rigging.webp',
    ...
    [
        ...
        'category' => 'Crane Operations',
        'image' => 'assets/images/training/training-overhead-crane-operator.webp',
    ...
    [
        ...
        'category' => 'Equipment',
        'image' => 'assets/images/training/training-mobile-elevated-work-platform.webp',
    ...
    [
        ...
        'category' => 'Equipment',
        'image' => 'assets/images/training/training-telehandler-operator.webp',
    ...
    [
        ...
        'category' => 'Equipment',
        'image' => 'assets/images/training/training-system-scaffolding.webp',
    ...
    [
        ...
        'image' => 'assets/images/training/training-whmis.webp',
    ...
    [
        ...
        'category' => 'Workplace Safety',
        'image' => 'assets/images/training/training-lockout-tagout.webp',
    ...
    [
        ...
        'category' => 'Workplace Safety',
        'image' => 'assets/images/training/training-confined-space-v2.webp',
    ...
    [
        ...
        'category' => 'Workplace Safety',
        'image' => 'assets/images/training/training-fall-protection.webp',
    ...
    [
        ...
        'category' => 'Workplace Safety',
        'image' => 'assets/images/training/training-fall-rescue-systems.webp',
    ...
    [
        ...
        'category' => 'Workplace Safety',
        'image' => 'assets/images/training/training-chainsaw-safety.webp',
...
?>
    ...
    <section class="bg-white pt-14 md:pt-20 pb-8 md:pb-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 select-text">
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-7 lg:gap-12">
                <div class="max-w-3xl">
                    ...
                    <p class="text-base md:text-lg text-slate-600 font-light leading-relaxed">
                        Explore LEEA accredited and industry-recognized training for rigging, crane and equipment operation, fall protection, confined space, and workplace safety.
                    </p>
                </div>
                <a href="<?php echo site_escape($training_portal_url); ?>" target="_blank" rel="noopener" class="inline-flex w-fit shrink-0 items-center border border-spartan-teal text-spartan-teal py-3 px-6 text-xs font-bold tracking-[0.2em] uppercase hover:bg-spartan-teal hover:text-white transition-colors">
                    <span>View All at Hercules</span>
                    <i class="fa-solid fa-arrow-up-right-from-square text-[11px] ml-2.5" aria-hidden="true"></i>
                </a>
            </div>
        </div>
    </section>
    ...
    <!-- Course grid -->
    <section class="bg-white pt-8 md:pt-10 pb-14 md:pb-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 select-text">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                <?php foreach ($training_courses as $course): ?>
                    <article class="group bg-white border border-slate-200 flex flex-col min-h-[440px]">
                        <a href="<?php echo site_escape($course['url']); ?>" target="_blank" rel="noopener" class="relative block aspect-[4/3] overflow-hidden bg-spartan-navy">
